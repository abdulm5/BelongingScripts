            ...
            <section className="ed-quote section container">
                ...
                >
                    ...
                    <div className="quote-content border-top-thick">
                        <h3 className="font-serif mt-6">— <br />Who enters the conversation, who hesitates, who gets understood, and who is dismissed are shaped by discourse patterns people are expected to know but are rarely taught.</h3>
                        <div className="mt-8">
